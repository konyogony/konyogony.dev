...
export const WikiSidebar = ({ folders, structure, openedFolders, toggleFolder }: WikiSidebarProps) => {
    return (
        <div className='sticky top-24 hidden h-full w-fit min-w-[15vh] flex-shrink-0 flex-col items-start lg:flex'>
            ...
            {folders &&
                folders.map((v, i) => (
                    <WikiFolder key={i} name={v} isOpened={openedFolders[v]} onToggle={toggleFolder}>
