    ...
    html!(
        <div class="h-full w-full bg-gray-700 flex flex-col justify-center items-center">
            <div class="border border-white/5 px-16 py-8 rounded-lg bg-gray-600 flex flex-col gap-2 items-center">
                <span class="text-3xl font-bold mb-8">{"Whoops! Something went wrong..."}</span>
                <span>{"Seems like something went wrong... Try again later and if the issure persists contact the administrator."}</span>
